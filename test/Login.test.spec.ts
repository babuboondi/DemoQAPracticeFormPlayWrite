...
//TestCases for new Form application:-Its not possibleto apply all the test cases on dummy for 
...
test.describe("Practice Form DEMOQA Feature @login", async () => {
    ...
    test("Positive: Standard user tries to Enter proper Details", async ({ page }) => {
